                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-field">
                                                ...
                                                <input name="ten" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-field">
                                                <label>Address <span class="red">*</span></label>
                                                <input name="diachi" required="required" type="text"></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-field">
                                                ...
                                                <input name="sdt" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-field">
                                        ...
                                        <div class="col-md-12 payment-bt">
                                            <div class="center">
                                                <button class="bt_main">Đăng Ký</button>
                                            </div>
                                        </div>
                                    </div>
                            </form>
